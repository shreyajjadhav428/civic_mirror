      ...
      >
        ...
        <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          ...
          {themes.map((theme, index) => (
            ...
            <article
              key={theme.number}
              className="group relative min-w-0 min-h-[225px] rounded-2xl overflow-hidden border border-[#16405F]/[0.14] bg-[#FCFDFC] px-6 py-8 transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_12px_28px_rgba(22,64,95,0.10)]"
            >
